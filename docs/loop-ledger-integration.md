...
P1 first (small, hardens the core anti-false-completion gate), then P2 (ledger persistence — multiplies resume reliability), P3 (retry hygiene), P4-P5 as polish. P1+P3 touch only existing fail/review paths; P2 adds a new projection artifact with tests in `goal_dossier` style.
